...
<div class="section-header">
    <h1>Report Pengeluaran Sales</h1>
...
<div class="section-body">
    {{-- Title --}}
    <h2 class="section-title">Data Report Pengeluaran Sales</h2>
                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{ route('report.pengeluaran.sales.detail' , $data->id) }}" class="btn btn-info">Detail</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
