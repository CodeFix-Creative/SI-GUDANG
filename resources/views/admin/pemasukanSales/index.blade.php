...
@section('pemasukan-sales' , 'active')

@section('content')
<div class="section-header">
    <h1>Pemasukan Sales</h1>
...
<div class="section-body">
    {{-- Title --}}
    <h2 class="section-title">Data Pemasukan Sales</h2>
    ...
    <div class="row">
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @if($barang->stock < 1) <i class="text-danger">Stok telah habis.</i>
                                                @else
                                                <a href="#!" class="btn btn-success btn-sm ubah-data float-left"
                                                    data-toggle="modal" data-target="#editdata"
                                                    data-id="{{ $barang->id }}"
                                                    data-nama-barang="{{ $barang->nama_produk }}"
                                                    data-harga-barang="{{ $barang->harga }}"
                                                    data-stok="{{ $barang->stock }}" data-qty="{{ $barang->satuan }}"
                                                    data-status="{{ $barang->status }}" data-token="{{csrf_token()}}"><i
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="{{ route('checkoutSales') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{-- form sales --}}
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Nama Sales"
                                    aria-label="Nama Pelaanggan" aria-describedby="basic-addon2" name="nama_sales"
                                    ...
                                    <tr class="list-cart" id="{{ $cart['id'] }}">
                                        ...
                                        <td>
                                            <a href="#!" class="btn btn-sm btn-danger hapus-cart"
                                                ...
                                                data-url-hapus="{{ route('removeCartSales') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="border-top:none;">
                    <button type="submit" class="btn btn-primary" id="tambah-cart"
                        ...
                        data-url-tambah="{{ route('addToCartSales') }}">Tambah</button>
                </div>
                {{-- </form> --}}
                <!-- /FORM -->
            </div>
