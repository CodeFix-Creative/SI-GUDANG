    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('produk-masuk.update' , $data->id) }}" enctype="multipart/form-data" method="post">
                     @method('PUT')
                     @csrf
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <select class="form-control select2" name="id_suplier">
                                    ...
                                    <option value="{{ $item->id }}" {{ ($data->id_suplier == $item->id) ? 'selected' : '' }}>{{ $item->nama_suplier }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
