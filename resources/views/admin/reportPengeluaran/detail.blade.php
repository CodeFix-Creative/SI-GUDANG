...
<div class="section-header">
    <div class="section-header-back">
        <a href="{{ route('report.pengeluaran.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
    </div>
...
<div class="section-body">
    {{-- Title --}}
    <h2 class="section-title">Data Report Pengeluaran Tanggal {{ date('d/m/Y', strtotime($parent->tanggal_transaksi)) }}</h2>
