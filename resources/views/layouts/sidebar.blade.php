<ul class="sidebar-menu">
    ...
    <li class="@yield('dashboard')"><a class="nav-link" href="{{ route('dashboard.index') }}"><i class="fas fa-fire"></i> <span>Dashboard</span></a>
    ...
    <li class="dropdown @yield('kategori-produk') @yield('produk') @yield('produk-harga') @yield('produk-masuk')">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="@yield('produk-harga')"><a class="nav-link" href="{{ route('produk-harga.index') }}"><span>Produk Harga</span></a>
            </li>
